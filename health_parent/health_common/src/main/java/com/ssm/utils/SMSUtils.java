...
public class SMSUtils {
    ...
    public static void sendShortMessage(String templateCode, String phoneNumbers, String param) throws ClientException {
        ...
        // 替换成你的AK
        final String accessKeyId = "LTAI4G3GTT8tbNj8mi7WnH3i";// 你的accessKeyId,参考本文档步骤2  阿里云申请秘钥AK,每个人都不一样
        final String accessKeySecret = "neO1rHHijKgDKKtNwG6rKtc73Btsog";// 你的accessKeySecret，参考本文档步骤2  阿里云申请秘钥SK,每个人都不一样
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("传值健康");  //阿里云短信服务的短信签名,注意要与阿里云里面申请的签名一致,当时写错了一个字
    ...
    public static void main(String[] args) {
        try {
            SMSUtils.sendShortMessage(SMSUtils.VALIDATE_CODE, "18395557858", "1234");
